...
def parse_args():
    ...
    parser.add_argument('--output', type=str, default='simkgc_checkpoint',
    ...
    parser.add_argument("--dataset_dir", default='local_dataset', type=str)
