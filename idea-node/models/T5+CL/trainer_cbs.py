from modeling_t5 import ContrastiveT5ForConditionalGeneration
...
from utils_ import LossMeter, set_global_logging_level, reduce_dict, setup_for_distributed, accuracy, get_prefix_allowed_tokens_fn
...
class Trainer:
    def __init__(self, args, train_loader=None, val_loader=None, test_loader=None, tokenizer=None, sampler=None, entity_list=None, train=True):
        self.args = args
        ...
        self.prefix_allowed_tokens_fn = get_prefix_allowed_tokens_fn(tokenizer, entity_list)
            ...
            for batch in self.train_loader:
                ...
                if self.args.fp16:
                    with autocast():
                        ...
                        neg_num_total = self.args.neg_num
...
def main_worker(gpu, args):
    ...
    if args.test_only:
        ...
        entity_list = entity_dataset.entity_tokenize

        trainer = Trainer(args, train_loader, val_loader, test_loader, tokenizer, sampler, entity_list, train=False)
        trainer.predict()
        ...
        trainer = Trainer(args, train_loader, val_loader, test_loader, tokenizer, sampler, entity_list, train=True)
