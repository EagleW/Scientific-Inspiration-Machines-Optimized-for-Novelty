...
os.makedirs('../models/Dual_Encoder+CL+NBRlocal_kg_dataset', exist_ok=True)
src = '../models/Dual_Encoder/local_dataset/entities.json'
dst = '../models/Dual_Encoder+CL+NBR/local_kg_dataset/entities.json'
shutil.copyfile(src, dst)
out_name = '../models/Dual_Encoder+CL+NBR/local_kg_dataset/%s.json'
